<template>
  <div>
    <n-card title="N2" class="shadow-sm rounded-16px parent-box">
                ...
                <div class="flex-col-center p-2px">
                  <n-grid :x-gap="2" :y-gap="2" :cols="3">
                    ...
                    <n-grid-item>
                      ...
                      <div style="text-align: center">
                        <n-button type="primary" class="button-style">{{ lowSwitch }}</n-button>
                      </div>
                    </n-grid-item>
                    <n-grid-item>
                      <div class="flex-col-center p-3px">
      ...
      <div class="p-10px">
        <n-button type="primary" size="large" @click="chickHeat">加热</n-button>
        <n-button type="primary" size="large" style="margin-left: 10px" @click="chickOnTrack">轨道</n-button>
...
import { savaAsN2File, saveEditFile, selectN2 } from '@/service/api/parm';
...
async function saveFile() {
	...
	console.log(param);
	const success = await savaAsN2File(param);
	if (success) {
		saveEdit();
	}
}
