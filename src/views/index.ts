...
> = {
  ...
  file_heat: () => import('./file/heat/index.vue'),
  file_mes: () => import('./file/mes/index.vue'),
  file_n2: () => import('./file/n2/index.vue'),
  file_track: () => import('./file/track/index.vue'),
  file_vacuum: () => import('./file/vacuum/index.vue'),
  ...
  parameter_system: () => import('./parameter/system/index.vue'),
  ...
  profile_file: () => import('./profile/file/index.vue'),
  ...
  user_home: () => import('./user/home/index.vue'),
