          ...
          <n-grid x-gap="12" :cols="2">
            ...
            <n-gi>
              <n-space vertical style="margin-top: 15%">
                ...
                <n-button secondary strong style="width: 100%" @click="resetProduct">
                  <icon-material-symbols-cleaning-services class="text-24px" />
                  重置
                </n-button>
              </n-space>
      ...
      <n-gi>
        <n-card class="shadow-sm rounded-16px card-tail-height">
          <n-grid x-gap="12" y-gap="8" :cols="2">
            ...
            <n-gi>
              <n-input :placeholder="inletSensorTime">
                <template #prefix>时间</template>
              </n-input>
            </n-gi>
            <n-gi>
              <n-input :placeholder="vacuumSensorTime">
      ...
      <n-gi>
        <n-card class="shadow-sm rounded-16px card-tail-height">
          ...
          <n-grid x-gap="12" y-gap="8" :cols="2">
            ...
            <n-gi>
              <n-input :placeholder="vacuumOutletSensorTime">
                <template #prefix>到达</template>
              </n-input>
            </n-gi>
          </n-grid>
...
import { deleteAllProduct } from '@/service/api/user';
...
const inletSensorTime = ref('16:28:00');
const vacuumSensorTime = ref('16:31:40');
const vacuumOutletSensorTime = ref('16:32:59');
const uuid = ref('');
