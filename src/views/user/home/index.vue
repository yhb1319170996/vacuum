<template>
  <div>
        ...
        <n-form ref="formRef" :rules="rules" :model="model">
          <n-form-item label="用户名" path="userName">
            <n-input
              ...
              placeholder="请输入用户名"
              :input-props="{ onClick: () => clickOnUserName() }"
            ></n-input>
          </n-form-item>
          <n-form-item label="密码" path="password">
            <n-input
              ...
              placeholder="请输入密码"
              :input-props="{ onClick: () => clickOnPwd() }"
            ></n-input>
          </n-form-item>
          <n-form-item label="级别" path="userRole">
            <n-select v-model:value="model.userRole" :options="options"></n-select>
          </n-form-item>
          <n-row :gutter="[0, 24]">
            <n-col :span="24">
    ...
    <n-modal v-model:show="coverShowModalPwd" class="rounded-10px" preset="card" title="请输入" style="width: 800px">
...
const coverShowModalPwd = ref(false);
...
function clickOnPwd() {
  ...
  if (coverShowModalPwd.value === true) {
    coverShowModalPwd.value = false;
  } else {
    coverShowModalPwd.value = true;
  }
}
...
const onChangeDownPwd = (e: string) => {
  finalPwd.value = e;
  model.password = e;
};
</script>
