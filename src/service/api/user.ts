...
export function deleteAllLog() {
  return requestFinal.post<string>(`/log/deleteAllLog`);
}

export function deleteAllProduct() {
  return requestFinal.post<string>(`/product/deleteAllProduct`);
}

export function getVacuumSwitch() {
  return requestFinal.post<boolean>(`/tab/getVacuumSwitch`);
}
